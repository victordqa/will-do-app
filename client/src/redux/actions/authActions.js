...
export const loadUser = () => async (dispatch, getState) => {
    ...
    try {
        let res = await axios.get('/api/auth/user', tokenConfig(getState))
...
export const registerAction = ({ username, email, password }) => async (
    ...
    try {
        let res = await axios.post('/api/user/add', data, tokenConfig(getState))
...
export const logInAction = ({ email, password }) => async (
    ...
    try {
        let res = await axios.post('/api/auth', data, tokenConfig(getState))
